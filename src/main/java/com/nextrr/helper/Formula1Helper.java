...
public class Formula1Helper {
	...
	public String getFormula1Schedule() {
		...
		for (Map<String, Object> f1ScheduleMap : f1ScheduleList) {
			...
			Map<String, Object> f1PracticeAndQualifying = dbUtils.getEntityDataWithConditions("formula_one_practice", formula1Params);
			List<Map<String, Object>> f1PracticeAndQualifyingList = (List<Map<String, Object>>) f1PracticeAndQualifying.get("result");
			...
			for (Map<String, Object> f1PracticeAndQualifyingMap : f1PracticeAndQualifyingList) {
				...
				String practiceDate = (String) DefaultObjects.formatDate((String) f1PracticeAndQualifyingMap.get("date"));
				String practiceTime = (String) DefaultObjects.formatTimeForFrontEnd((String) f1PracticeAndQualifyingMap.get("time"));
				...
				formula1Map.put(raceTypeId, f1First.getF1SessionSchedule(sessionName, practiceDate, practiceTime, formulaOneId, raceTypeId, practiceId));
			}
	...
	public String getFormula1ToEdit() {
		...
		for (Map<String, Object> f1ScheduleMap : f1ScheduleList) {
			...
			for (Map<String, Object> f1PracticeAndQualifyingMap : f1PracticeAndQualifyingList) {
				...
				formula1PracticeMap.put("result", f1First.getF1SessionSchedule(sessionName, practiceDate, practiceTime, formulaOneId, raceTypeId, formulaOnePracticeId));
	...
	public String removeF1Schedule(MultivaluedMap<String, String> params) {
		...
		if ("MAINRACE".equals(raceType)) {
			...
			List<Map<String, Object>> formula1PracticeList = (List<Map<String, Object>>) formula1PracticeMap.get("result");
